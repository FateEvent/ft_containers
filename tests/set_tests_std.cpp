...
typedef std::set<int, std::string>::iterator ft_iterator;
typedef std::set<int, std::string>::const_iterator ft_const_iterator;
...
int main() {
	...
	std::set<char>::iterator	it = tree.find('c');
	if (it != tree.end())
		std::cout << *it << std::endl;
	...
	set.insert(90);
	set.insert(56);
	std::set<int> cherrytree(set.begin(), set.end());
