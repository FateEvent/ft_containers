...
namespace ft
{
	...
	public :
		...
		set_iterator() : _ptr(&_dummy), _last(NULL), _dummy() {}
		set_iterator(node_pointer ptr) : _ptr(ptr), _last(NULL), _dummy() {}
		set_iterator(const set_iterator &other) : _ptr(other._ptr), _last(other._last), _dummy(other._dummy) {}
